...
git clone -q --depth=1 https://github.com/morytyann/OpenWrt-mihomo.git package/luci-app-mihomo
...
git_sparse_clone openwrt-23.05 https://github.com/immortalwrt/packages.git net/adguardhome
